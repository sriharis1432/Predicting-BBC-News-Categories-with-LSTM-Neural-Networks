...
Original file is located at
    https://colab.research.google.com/drive/1nDgV94vvmRJr6HgvMxwWDKtaF7eCbWPv
"""
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Embedding(4000, embedding_dim),
...
txt = [" dhoni is a good cricket batsman in  batting"]
seq = tokenizer.texts_to_sequences(txt)
padded = pad_sequences(seq, maxlen=max_length)
pred = model.predict(padded)
labels = ['sport', 'bussiness', 'politics', 'tech', 'entertainment','unknown']
seq = tokenizer.texts_to_sequences(labels)
print(pred, seq[np.argmax(pred)])
